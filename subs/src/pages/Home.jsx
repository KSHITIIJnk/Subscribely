...
const SubscriptionCard = ({ title, description, icon: Icon }) => (
  <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col items-center text-center">
    ...
    <a href="#learn-more" className="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center">
...
const Home = () => {
  const subscriptions = [
    { title: "Streaming Services", description: "Enjoy a variety of movies and TV shows from popular streaming platforms.", icon: Tv },
    { title: "Music Platforms", description: "Stream your favorite music and discover new artists.", icon: Music },
    { title: "Transportation", description: "Convenient transportation options at your fingertips.", icon: Car },
    { title: "Fitness Plans", description: "Stay healthy and fit with personalized fitness subscriptions.", icon: Dumbbell },
    { title: "Learning Platforms", description: "Access courses and learn new skills from home.", icon: BookOpen },
    ...
    <div className="bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <a href="#subscribe" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full text-lg transition duration-300 inline-flex items-center">
        ...
        <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
          ...
          <a href="#explore" className="bg-white text-blue-600 hover:bg-blue-100 font-bold py-3 px-8 rounded-full text-lg transition duration-300 inline-flex items-center">
